            ...
            <Suspense fallback={<LoadingFallback />}>
              <Routes>
                ...
                >
                  ...
                  <Route path="/assets-v2" element={<ModuleRoute module="assets"><AssetsV2Page /></ModuleRoute>} />
                  <Route path="/investments" element={<ModuleRoute module="assets"><InvestmentsPage /></ModuleRoute>} />
                  <Route path="/events" element={<ModuleRoute module="assets"><EventsPage /></ModuleRoute>} />
