...
export const assets = {
  ...
  // O bloco de transacoes do upstream (transactions/allTransactions/
  // addTransaction/updateTransaction/deleteTransaction/buy) foi removido:
  // duplicava chaves com as nossas, acima, e apontava para endpoints que
  // nao entraram no merge por falarem kind/quantity em vez dos dez tipos
  // de lancamento do fork.
  previewImport: async (
    file: File,
