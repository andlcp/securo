...
export const navItems: NavItem[] = [
  ...
  // O "Patrimônio" original fica fora da barra lateral, mas segue montado
  // em /assets: é assim que continuamos recebendo as atualizações do
  // Securo original sem exibir uma entrada duplicada ao lado do
  // Patrimônio (assets-v2) que virou o canônico aqui.
  // { type: 'link', key: 'assets', path: '/assets', icon: Landmark, module: 'assets' },
  { type: 'link', key: 'assetsV2', path: '/assets-v2', icon: Landmark, module: 'assets' },
  { type: 'link', key: 'investments', path: '/investments', icon: TrendingUp, module: 'assets' },
  { type: 'link', key: 'events', path: '/events', icon: ScrollText, module: 'assets' },
